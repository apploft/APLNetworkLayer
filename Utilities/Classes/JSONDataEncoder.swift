...
public class JSONDataEncoder {
    ...
    public static func withObject<T: Encodable>(_ object: T, keyEncodingStrategy: JSONEncoder.KeyEncodingStrategy = .convertToSnakeCase, dateEncodingStrategy: JSONEncoder.DateEncodingStrategy = .iso8601) throws -> Data? {
